...
\caption{Poverty and Gini changes across the LVT rate grid. \emph{Note:} council tax abolished throughout; rates above the budget-neutral 0.77 per cent raise net revenue that is not recycled, so the upper grid shows the gross incidence of the levy rather than a complete reform package. \emph{Source:} Authors' calculations; \texttt{analysis/figures.py}.}
\label{fig:povgini}
\end{figure}
...
Excluding directly owned land        & 6.79 & 0.85 & 66.3 & $+$675 & $-$1{,}177 & $-$5{,}128 & $-$0.77 \\
